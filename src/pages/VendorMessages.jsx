...
export default function VendorMessages() {
  return (
    <div className="bg-[#001206] text-[#ccfcd8] h-screen font-body overflow-hidden">
      {/* Sidebar Navigation */}
      <aside className="hidden md:flex flex-col h-[calc(100vh-64px)] w-64 fixed left-0 top-16 bg-[#001f0e] shadow-md p-6 space-y-2 z-50 border-r border-[#255036]/30">
      ...
      <main className="md:ml-64 h-[calc(100vh-64px)] mt-16 flex flex-row">
        ...
        <section className="w-80 md:w-96 border-r border-[#255036]/50 flex flex-col bg-[#001809]">
          <div className="p-6 space-y-3">
            <h2 className="font-headline-md text-[24px] font-bold text-[#5ff077]">Conversations</h2>
            <div className="relative">
              ...
              <input className="w-full bg-surface-variant border-none rounded-lg pl-10 py-2 text-[16px] focus:ring-2 focus:ring-[#5ff077] text-on-surface outline-none" placeholder="Search chats..." type="text"/>
            </div>
          </div>
            ...
            <div className="p-6 flex items-start gap-3 cursor-pointer bg-surface-container-high border-l-4 border-primary transition-all">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="font-caption text-[12px] text-[#5ff077]">12:45 PM</span>
                </div>
        ...
        {/* Main Chat Area */}
        <section className="flex-1 flex flex-col bg-[#001206] overflow-hidden">
          {/* Chat Header */}
          <header className="h-20 flex items-center justify-between px-6 border-b border-[#255036]/50 bg-[#001206] shadow-sm flex-shrink-0">
            <div className="flex items-center gap-3">
              <img className="w-10 h-10 rounded-full border border-[#5ff077] object-cover" alt="Sarah Jenkins" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCeFz2QXQgTV1jqHVJaCB6dJjoZ1hpMPCD964C-LlQltCYTdOb5awpuqpt8j09Hh81QX0kClXvHxqRTZwTGGvPj2CXgfDjmKsfvVJFx86OMi33rN4fc14pXnekFzjOev_abKXMN2wDQHCtGqMJO61ieBAwcnToAzpD-_kEt7wtmlGfGoHz5oBNoCEy57fkufkrOxgD8WzUrOoCjDfFQPTa0nhz0ow4dSce0uU1mqvLm9f7ux8rcmY2r79Aeir_Tbvg8ducmtTHno_SP"/>
              <div>
          ...
          <div className="flex-1 overflow-y-auto p-12 space-y-12 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[#255036] [&::-webkit-scrollbar-thumb]:rounded-full bg-[radial-gradient(circle_at_top_right,rgba(0,45,22,0.2),#001206)]">
            ...
            <div className="flex items-end gap-3 max-w-[80%]">
              ...
              <div className="space-y-1">
                <div className="bg-surface-container p-6 rounded-tr-3xl rounded-tl-3xl rounded-br-3xl text-[16px] text-on-surface border border-[#255036]">
            ...
            <div className="flex items-end justify-end gap-3 ml-auto max-w-[80%]">
              <div className="space-y-1 text-right">
                ...
                <div className="flex items-center justify-end gap-1 font-caption text-[12px] text-[#5ff077]">
                  <span>12:44 PM</span>
          ...
          {/* Input Area */}
          <footer className="p-6 bg-[#001206] border-t border-[#255036]/50 flex-shrink-0">
            <div className="flex items-center gap-3 max-w-4xl mx-auto">
              ...
              <div className="flex-1 relative">
                <input className="w-full bg-surface-container-high border border-[#255036] rounded-full px-6 py-3 text-[16px] text-on-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Type a message..." type="text"/>
        ...
        {/* Right Detail Panel */}
        <section className="w-64 border-l border-[#255036]/50 bg-[#001809] hidden lg:flex flex-col p-6">
          <h4 className="font-label-md text-[14px] font-bold text-[#5ff077] mb-6 uppercase tracking-wider">Rescue Details</h4>
          <div className="bg-surface-variant rounded-xl p-6 mb-6 border border-[#255036]">
          ...
          <h4 className="font-label-md text-[14px] font-bold text-[#5ff077] mb-6 uppercase tracking-wider">Recipient Info</h4>
          ...
          <div className="mt-auto">
            <button className="w-full py-2 border border-[#537f61] text-on-surface-variant font-bold text-[14px] rounded-lg hover:bg-surface-variant transition-colors cursor-pointer">
              Report User
            </button>
          </div>
        </section>
